...
def main():
    ...
    checkpoint_path = st.text_input("Enter the path to the checkpoint file", "checkpoint.pth")
    ...
    if train:
        logging_path = st.text_input("Enter the path for saving logging file", "loggingINFO.log")
